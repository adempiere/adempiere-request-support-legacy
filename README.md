# Request Support Library for ADempiere
...
A result for this library is published here: https://repo1.maven.org/maven2/io/github/adempiere/request-support-legacy/1.0.0/
